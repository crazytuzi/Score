...
(function() {
    if (!window.CKEDITOR)window.CKEDITOR = (function() {
        var a = {timestamp:'A39E',version:'3.2.1',revision:'5372',_:{},status:'unloaded',basePath:(function() {
    ...
    a.ENTER_BR = 2;
    a.ENTER_DIV = 3;
    a.config = {customConfig:'config.js',autoUpdateElement:true,baseHref:'',contentsCss:a.basePath + 'contents.css',contentsLangDirection:'ltr',language:'',defaultLanguage:'en',enterMode:1,forceEnterMode:false,shiftEnterMode:2,corePlugins:'',docType:'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',bodyId:'',bodyClass:'',fullPage:false,height:200,plugins:'about,easyUpload,uicolor,a11yhelp,basicstyles,blockquote,button,clipboard,colorbutton,colordialog,contextmenu,div,elementspath,enterkey,entities,filebrowser,find,flash,font,format,forms,horizontalrule,htmldataprocessor,image,indent,justify,keystrokes,link,list,maximize,newpage,pagebreak,pastefromword,pastetext,popup,preview,print,removeformat,resize,save,scayt,smiley,showblocks,showborders,sourcearea,stylescombo,table,tabletools,specialchar,tab,templates,toolbar,undo,wysiwygarea,wsc',extraPlugins:'',removePlugins:'',protectedSource:[],tabIndex:0,theme:'default',skin:'kama',width:'',baseFloatZIndex:10000};
    var i = a.config;
    ...
    (function() {
        ...
        d.range.prototype = {clone:function() {
            ...
            if (!this.collapsed) {
                t = t || a.SHRINK_TEXT;
                var u = this.clone(),v = this.startContainer,w = this.endContainer,x = this.startOffset,y = this.endOffset,z = this.collapsed,A = 1,B = 1;
    ...
    j.add('easyUpload', {requires:['dialog'],init:function(l) {
        var m = l.addCommand('easyUpload', new a.dialogCommand('easyUpload'));
        m.modes = {wysiwyg:1,source:1};
        m.canUndo = false;
        l.ui.addButton('EasyUpload', {label:l.lang.easyUpload.title,command:'easyUpload'});
        a.dialog.add('easyUpload', this.path + 'dialogs/easyUpload.js');
    }});
    (function() {
        ...
        var o = {exec:function(p) {
            ...
            if (q == 2) {
                ...
                if (z.length < 1) {
                    ...
                    s.insertNode(A);
                    A.append(new d.text('ï»¿', p.document));
                    s.moveToBookmark(B);
    ...
    k.button.prototype = {canGroup:true,render:function(l, m) {
        ...
        this._.editor = l;
        var t = {id:o,button:this,editor:l,focus:function() {
    ...
    (function() {
        ...
        var o = {canUndo:false,exec:c ? function(r) {
            ...
            switch (r.data.keyCode) {case 1000 + 86:case 2000 + 45:var s = this.document.getBody();if (!c && s.fire('beforepaste'))r.cancel(); else if (b.opera || b.gecko && b.version < 10900)s.fire('paste');return;case 1000 + 88:case 2000 + 46:var t = this;this.fire('saveSnapshot');setTimeout(function() {
                t.fire('saveSnapshot');
            }, 0);
            }
        };
        ...
        function q(r, s, t) {
            ...
            u.getBody().append(y);
            y.setStyles({position:'absolute',left:'-1000px',top:w.getStartElement().getDocumentPosition().y + 'px',width:'1px',height:'1px',overflow:'hidden'});
    ...
    j.add('colorbutton', {requires:['panelbutton','floatpanel','styles'],init:function(l) {
        ...
        ;
        function q(r, s) {
            var t = [],u = m.colorButton_colors.split(','),v = u.length + (m.colorButton_enableMore ? 2 : 1),w = e.addFunction(function(C, D) {
                if (C == '?') {
    ...
    j.contextMenu = e.createClass({$:function(l) {
        ...
        this.definition = {panel:{className:l.skinClass + ' cke_contextmenu',attributes:{'aria-label':l.lang.contextmenu.options}}};
    ...
    (function() {
        ...
        j.add('elementspath', {requires:['selection'],init:function(n) {
            ...
            n.on('selectionChange', function(s) {
                var t = b,u = s.data.selection,v = u.getStartElement(),w = [],x = s.editor,y = x._.elementsPath.list = [],z = x._.elementsPath.filters;
                while (v) {
                    var A = 0;
    ...
    a._.elementsPath = {click:function(l, m) {
        ...
        n = new d.event(n);
        switch (n.getKeystroke()) {case 37:case 9:r = a.document.getById(q + (m + 1));if (!r)r = a.document.getById(q + '0');r.focus();return false;case 39:case 2000 + 9:r = a.document.getById(q + (m - 1));if (!r)r = a.document.getById(q + (p._.elementsPath.list.length - 1));r.focus();return false;case 27:p.focus();return false;case 13:case 32:this.click(l, m);return false;
        }
        return true;
    }};
    (function() {
        ...
        j.enterkey = {enterBlock:function(s, t, u, v) {
            ...
            if (!v && y && o.test(B)) {
                ...
                u.deleteContents();
                u.insertNode(D);
                if (!c)w.createText('ï»¿').insertAfter(D);
    ...
    (function() {
        ...
        function o(p) {
            var q = {},r = [],s = {nbsp:'\xa0',shy:'Â­',gt:'>',lt:'<'};
    ...
    if (c)h.prototype.hasAttribute = function(l) {
        ...
        if (o.getName() == 'input')switch (l) {case 'class':return o.$.className.length > 0;case 'checked':return!!o.$.checked;case 'value':var n = o.getAttribute('type');if (n == 'checkbox' || n == 'radio')return o.$.value != 'on';break;default:
        }
    ...
    (function() {
        ...
        function o(p, q, r) {
            ...
            if (t) {
                switch (r) {case 'left':u.cssClassName = t[0];break;case 'center':u.cssClassName = t[1];break;case 'right':u.cssClassName = t[2];break;case 'justify':u.cssClassName = t[3];break;
                }
    ...
    j.link = {getSelectedLink:function(l) {
        var m;
        try {
    ...
    (function() {
        ...
        ;
        j.add('maximize', {init:function(r) {
            var s = r.lang,t = a.document,u = t.getWindow(),v,w,x,y = p(u, r),z = 2;
            r.addCommand('maximize', {modes:{wysiwyg:1,source:1},editorFocus:false,exec:function() {
                ...
                if (this.state == 2) {
                    ...
                    if (c)t.$.documentElement.style.overflow = t.getBody().$.style.overflow = 'hidden'; else t.getBody().setStyles({overflow:'hidden',width:'0px',height:'0px'});
                ...
                this.toggleState();
                var J = this.uiItems[0],K = this.state == 2 ? s.maximize : s.minimize,L = r.element.getDocument().getById(J._.id);
    ...
    (function() {
        ...
        var q = function() {
            ...
            if (x)x.addRules({elements:{span:function(y) {
        ...
        j.scayt = {engineLoaded:false,instances:{},getScayt:function(u) {
            ...
            var w = 'svc.spellchecker.net/spellcheck31/lf/scayt/scayt22.js',x = u.config.scayt_srcUrl || v + '//' + w,y = r.parseUrl(x).path + '/';
            a._djScaytConfig = {baseUrl:y,addOnLoad:[function() {
                a.fireOnce('scaytReady');
            }],isDebug:false};
            a.document.getHead().append(a.document.createElement('script', {attributes:{type:'text/javascript',src:x}}));
            return null;
        },parseUrl:function(u) {
            var v;
        ...
        },t = {preserveState:true,editorFocus:false,exec:function(u) {
            if (r.isScaytReady(u)) {
        ...
        j.add('scayt', {requires:['menubutton'],beforeInit:function(u) {
            ...
            if (z[0] == 1)E.scaytOptions = {label:u.lang.scayt.options,group:D,onClick:function() {
                m = 'options';
                u.openDialog(l);
            }};
            if (z[1] == 1)E.scaytLangs = {label:u.lang.scayt.langs,group:D,onClick:function() {
                m = 'langs';
                u.openDialog(l);
            }};
            if (z[2] == 1)E.scaytDict = {label:u.lang.scayt.dictionariesTab,group:D,onClick:function() {
                m = 'dictionaries';
                u.openDialog(l);
            }};
            E.scaytAbout = {label:u.lang.scayt.about,group:D,onClick:function() {
                m = 'about';
                u.openDialog(l);
            }};
            z[3] = 1;
            r.uiTabs = z;
            u.addMenuItems(E);
            u.ui.add('Scayt', 5, {label:u.lang.scayt.title,title:u.lang.scayt.title,className:'cke_button_scayt',onRender:function() {
                x.on('state', function() {
                ...
                return{scaytToggle:2,scaytOptions:G && r.uiTabs[0] ? 2 : 0,scaytLangs:G && r.uiTabs[1] ? 2 : 0,scaytDict:G && r.uiTabs[2] ? 2 : 0,scaytAbout:G && r.uiTabs[3] ? 2 : 0};
            }});
            if (u.contextMenu && u.addMenuItems)u.contextMenu.addListener(function() {
                ...
                if (N) {
                    u.addMenuItem('scayt_moresuggest', {label:u.lang.scayt.moreSuggestions,group:'scayt_moresuggest',order:10,getItems:function() {
                        return v;
                    }});
    ...
    (function() {
        j.add('stylescombo', {requires:['richcombo','styles'],init:function(m) {
            ...
            ;
            m.ui.addRichCombo('Styles', {label:o.label,title:o.panelTitle,className:'cke_styles',panel:{css:m.skin.editor.css.concat(n.contentsCss),multiSelect:true,attributes:{'aria-label':o.panelTitle}},init:function() {
                var s = this;
                r(function() {
                    var t,u,v;
                ...
                var s = m.getSelection(),t = s.getSelectedElement(),u = new d.elementPath(t || s.getStartElement()),v = [0,0,0,0];
                z.showAll();
                z.unmarkAll();
                for (var w in p) {
                    var x = p[w],y = x.type;
    ...
    (function() {
        ...
        function B(F, G, H) {
            ...
            var K,L = I[0],M = L.getAscendant('table'),N = y(M),O = N.length,P = N[0].length,Q = L.getParent().$.rowIndex,R = z(N, Q, L);
            if (G) {
                var S;
                try {
            ...
            for (var Z = 0; Z < I.length; Z++) {
                K = I[Z];
                var aa = K.getParent(),ab = K.getFirst(),ac = K.$.colSpan,ad = K.$.rowSpan,ae = aa.$.rowIndex,af = z(N, ae, K);
                Y += ac * ad;
        ...
        function C(F, G) {
            ...
            var I = H[0],J = I.getParent(),K = J.getAscendant('table'),L = y(K),M = J.$.rowIndex,N = z(L, M, I),O = I.$.rowSpan,P,Q,R,S;
            if (O > 1) {
                Q = Math.ceil(O / 2);
                R = Math.floor(O / 2);
                S = M + Q;
        ...
        function D(F, G) {
            var H = n(F);
            if (H.length > 1)return false; else if (G)return true;
            var I = H[0],J = I.getParent(),K = J.getAscendant('table'),L = y(K),M = J.$.rowIndex,N = z(L, M, I),O = I.$.colSpan,P,Q,R;
            if (O > 1) {
                Q = Math.ceil(O / 2);
                R = Math.floor(O / 2);
            } else {
        ...
        j.tabletools = {init:function(F) {
            ...
            F.addCommand('rowDelete', {exec:function(H) {
                var I = H.getSelection();
                x(r(I));
            }});
            F.addCommand('rowInsertBefore', {exec:function(H) {
                var I = H.getSelection();
                q(I, true);
            }});
            F.addCommand('rowInsertAfter', {exec:function(H) {
                var I = H.getSelection();
                q(I);
            }});
            F.addCommand('columnDelete', {exec:function(H) {
                var I = H.getSelection();
                t(I);
            }});
            F.addCommand('columnInsertBefore', {exec:function(H) {
                var I = H.getSelection();
                s(I, true);
            }});
            F.addCommand('columnInsertAfter', {exec:function(H) {
                var I = H.getSelection();
                s(I);
            }});
            F.addCommand('cellDelete', {exec:function(H) {
                var I = H.getSelection();
                v(I);
            }});
            F.addCommand('cellMerge', {exec:function(H) {
                x(B(H.getSelection()), true);
            }});
            F.addCommand('cellMergeRight', {exec:function(H) {
                x(B(H.getSelection(), 'right'), true);
            }});
            F.addCommand('cellMergeDown', {exec:function(H) {
                x(B(H.getSelection(), 'down'), true);
            }});
            F.addCommand('cellVerticalSplit', {exec:function(H) {
                x(C(H.getSelection()));
            }});
            F.addCommand('cellHorizontalSplit', {exec:function(H) {
                x(D(H.getSelection()));
            }});
            F.addCommand('cellInsertBefore', {exec:function(H) {
                var I = H.getSelection();
                u(I, true);
            }});
            F.addCommand('cellInsertAfter', {exec:function(H) {
                var I = H.getSelection();
                u(I);
            }});
            if (F.addMenuItems)F.addMenuItems({tablecell:{label:G.cell.menu,group:'tablecell',order:1,getItems:function() {
    ...
    (function() {
        ...
        j.add('toolbar', {init:function(n) {
            var o = function(p, q) {
                ...
                switch (q) {case u ? 37 : 39:case 9:do{
                    r = p.next;
                    if (!r) {
                        s = p.toolbar.next;
                        t = s && s.items.length;
                    ...
                    p = r;
                } while (p && !p.focus)if (p)p.focus(); else n.toolbox.focus();return false;case u ? 39 : 37:case 2000 + 9:do{
                    r = p.previous;
                    if (!r) {
                ...
                if (p.data.space == n.config.toolbarLocation) {
                    ...
                    for (var w = 0; w < v.length; w++) {
                        ...
                        if(w<3)
                            ...
                            r.push('<span id="', y, '" class="cke_toolbar" style="display:none;" role="presentation"><span class="cke_toolbar_start"></span>');
                        var A = u.push(z) - 1;
                        if (A > 0) {
                            z.previous = u[A - 1];
                            z.previous.next = z;
                    ...
                    if (n.config.toolbarCanCollapse) {
                        ...
                        n.addCommand('toolbarCollapse', {exec:function(H) {
                            var I = a.document.getById(G),J = I.getPrevious(),K = H.getThemeSpace('contents'),L = J.getParent(),M = parseInt(K.$.style.height, 10),N = L.$.offsetHeight,O = !J.isVisible(),TF = a.document.getById('toolBarFlag').isVisible();
                             var toolbars =   $$('span.cke_toolbar');
                             var leg = toolbars.length;
                            if (!TF) {
                                //J.hide();
                                for(var i=0;i<leg;i++){
                                    if(i>3)
                                ...
                                a.document.getById('toolBarFlag').show();
                               ...
                               for(var j=0;j<leg;j++){
                                ...
                                a.document.getById('toolBarFlag').hide();
                        ...
                        r.push('<a title="' + (s ? n.lang.toolbarExpand : n.lang.toolbarCollapse) + '" id="' + G + '" tabIndex="-1" class="cke_toolbox_collapser');
                        r.push(' cke_toolbox_collapser_min');
                        r.push('" onclick="CKEDITOR.tools.callFunction(' + F + ')">', '<span>&#9650;</span>', '</a>');
                        r.push('<span id="toolBarFlag">&nbsp;</span>');
                    }
                    p.data.html += r.join(''); 
                }
            });
    ...
    i.toolbar_Basic = [
        ['Bold','Italic','-','NumberedList','BulletedList','-','Link','Unlink','-','lineHeight','-','UIColor']
    ];
     i.toolbar_Full = [
        ['Source','-','Styles','Format','Font','FontSize','lineHeight','-','UIColor'],
    ...
    i.toolbar_Ext = [
        ...
        ['Link','Unlink','Anchor'],
        ['Save','NewPage','Preview','-','Templates'],
        ['Maximize','ShowBlocks','EasyUpload']
    ];
    i.toolbar = 'Full';
    ...
    (function() {
        ...
        ;
        j.add('wysiwygarea', {requires:['editingblock'],init:function(w) {
            var x = w.config.enterMode != 2 ? w.config.enterMode == 3 ? 'div' : 'p' : false,y = w.lang.editorTitle.replace('%1', w.name);
            w.on('editingBlockReady', function() {
                var B,C,D,E,F,G,H = b.isCustomDomain(),I = function(L) {
                    ...
                    B.append(C);
                },J = '<script id="cke_actscrpt" type="text/javascript" cke_temp="1">' + (H ? 'document.domain="' + document.domain + '";' : '') + 'parent.CKEDITOR._["contentDomReady' + w.name + '"]( window );' + '</script>',K = function(L) {
                    if (F)return;
                    F = 1;
                    w.fire('ariaWidget', C);
                ...
                w.addMode('wysiwyg', {load:function(L, M, N) {
                    B = L;
                    ...
                    D = true;
                    var M = w.config,N = M.fullPage,O = M.docType,P = '<style type="text/css" cke_temp="1">' + w._.styles.join('\n') + '</style>';
                    ...
                    var L = w.config,M = L.fullPage,N = M && w.docType,O = C.getFrameDocument(),P = M ? O.getDocumentElement().getOuterHtml() : O.getBody().getHtml();
    ...
    (function() {
        ...
        a.dialog.prototype = {resize:(function() {
            ...
            var W = this;
            var L = [],M = K.label ? ' title="' + e.htmlEncode(K.label) + '"' : '',N = K.elements,O = a.dialog._.uiElementBuilders.vbox.build(W, {type:'vbox',className:'cke_dialog_page_contents',children:K.elements,expand:!!K.expand,padding:K.padding,style:K.style || 'width: 100%; height: 100%;'}, L),P = h.createFromHtml(L.join(''));
    ...
    a.STYLE_OBJECT = 3;
    (function() {
        var l = {address:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,p:1,pre:1},m = {a:1,embed:1,hr:1,img:1,li:1,object:1,ol:1,table:1,td:1,tr:1,th:1,ul:1,dl:1,dt:1,dd:1,form:1},n = /\s*(?:;\s*|$)/;
        ...
        a.style.prototype = {apply:function(P) {
            O.call(this, P, false);
        },remove:function(P) {
            O.call(this, P, true);
            ...
            var T = this;
            switch (T.type) {case 1:return T.checkElementRemovable(P.block || P.blockLimit, true);case 3:case 2:var Q = P.elements;for (var R = 0,S; R < Q.length; R++) {
                S = Q[R];
            ...
            switch (this.type) {case 2:case 1:break;case 3:return P.lastElement.getAscendant(this.element, true);
            }
            return true;
        ...
        function p(P) {
            ...
            if (P.collapsed) {
                ...
                function ac() {
                    var af = new d.elementPath(R.getParent()),ag = new d.elementPath(aa.getParent()),ah = null,ai = null;
        ...
        ;
        function u(P) {
            var Q = /(\S\s*)\n(?:\s|(<span[^>]+_fck_bookmark.*?\/span>))*\n(?!$)/gi,R = P.getName(),S = v(P.getOuterHtml(), Q, function(U, V, W) {
                return V + '</pre>' + W + '<pre>';
            }),T = [];
        ...
        ;
        function y(P, Q) {
            var R = P._.definition,S = e.extend({}, R.attributes, J(P)[Q.getName()]),T = R.styles,U = e.isEmpty(S) && e.isEmpty(T);
            for (var V in S) {
    ...
    (function() {
        ...
        ;
        var q = {modes:{wysiwyg:1,source:1},exec:function(s) {
            switch (s.mode) {case 'wysiwyg':s.document.$.execCommand('SelectAll', false, null);
                break;case 'source':var t = s.textarea.$;if (c)t.createTextRange().execCommand('SelectAll'); else {
                t.selectionStart = 0;
        ...
        d.selection.prototype = {getNative:c ? function() {
            ...
            var t,u = z.getNative();
            switch (z.getType()) {case 3:return z.getSelectedElement();case 2:var v = z.getRanges()[0];if (v)if (!v.collapsed) {
                v.optimize();
                for (; ;) {
    ...
    (function() {
        ...
        d.range.prototype.select = c ? function(n) {
            ...
            if (t) {
                ...
                q.setHtml('&#65279;');
                q.insertBefore(s);
                if (p)x.document.createText('ï»¿').insertBefore(s);
            }
            x.setStartBefore(s);
            s.remove();
            if (o) {
    ...
    k.richCombo = e.createClass({$:function(l) {
        ...
        var r = e.addFunction(function(s, t) {
            ...
            switch (u) {case 13:case 32:case 40:e.callFunction(p, t);break;default:q.onkey(q, u);
            }
            s.preventDefault();
        });
        q.keyDownFn = r;
    ...
    k.panel.prototype = {renderHtml:function(l) {
        ...
        var m = this._.blocks,n = m[l],o = this._.currentBlock,p = this.forceIFrame ? this.document.getById('cke_' + this.id + '_frame') : this._.holder;
    ...
    k.panel.block = e.createClass({$:function(l, m) {
        ...
        var q = this;
        var m = q.keys[l];
        switch (m) {case 'next':var n = q._.focusIndex,o = q.element.getElementsByTag('a'),p;while (p = o.getItem(++n)) {
