...
//message锛氶渶瑕佸姞瀵嗙殑瀛楃涓�

//encrypt锛氬姞瀵嗚繕鏄В瀵嗭紝1涓哄姞瀵嗭紝0锛岃В瀵�
var des_key="sungoin";
...
else{tempresult+=String.fromCharCode(((left>>>16)&0xffff),(left&0xffff),((right>>>16)&0xffff),(right&0xffff));}/*瑙ｅ瘑鏃惰緭鍑哄弻瀛楄妭*/
...
if(document.encme.deskey.value==""){var tk=window.prompt("璇疯瀹氬瘑鐮侊紒","");if(tk){document.encme.deskey.value=tk;return true;}else return false;}
